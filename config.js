...
mapseries.config = {
  ...
  series: [
    ...
    {
      title: "Evropa; Souřadnicový systém 1942 1:200 000; Souřadnicový systém 1942 (S42) 1:200 000",
    ...
    {
      title: "Evropa; Základní mapa 1:200 000; Základní geologická mapa ČSR 1:200 000",
      layer: "evropa-zakladni-geologicka-mapa-csr-1200-000",
      template: "evropa-zakladni-geologicka-mapa-csr-1200-000.txt",
      formatFunctions: {
        addDegrees: function (stringValue, sheet) {
          stringValue += '';
          if(stringValue.length==4) {
    ...
    {
      title: "Evropa; Základní mapa 1:100 000; Základní geologická mapa ČSR 1:100 000",
      layer: "evropa-zakladni-geologicka-mapa-csr-1100-000",
      template: "evropa-zakladni-geologicka-mapa-csr-1100-000.txt",
      formatFunctions: {
        addDegrees: function (stringValue, sheet) {
          stringValue += '';
          if(stringValue.length==4) {
    ...
    {
      title: "Evropa; Základní mapa 1:10 000; Základní mapa ČSSR 1:10 000",
      layer: "evropa-zakladni-mapa-cssr-110-000",
      template: "evropa-zakladni-mapa-cssr-110-000.txt",
      formatFunctions: {
        addDegrees: function (stringValue, sheet) {
          stringValue += '';
          if(stringValue.length==4) {
